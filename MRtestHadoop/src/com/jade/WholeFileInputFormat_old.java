...
public class WholeFileInputFormat_old extends CombineFileInputFormat<NullWritable, Text>{
     ...
     */
      ...
      public RecordReader<NullWritable, Text> createRecordReader(
          ...
          if (!(split instanceof CombineFileSplit)) {
              ...
              return new CombineFileRecordReader<NullWritable, Text>((CombineFileSplit) split, context, WholeFileRecordReader_old.class);
      }
