...
public class WholeFileRecordReader_old extends RecordReader<NullWritable, Text> {
    private static final Logger LOG = Logger.getLogger(WholeFileRecordReader_old.class);
  ...
  //  private final Text mFileName;
     ...
     */
    public WholeFileRecordReader_old(CombineFileSplit fileSplit, TaskAttemptContext context,
