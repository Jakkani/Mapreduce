	  ...
	  public static class Map extends Mapper<LongWritable, Text, 
	    ...
	    protected void map(LongWritable key, Text value, 
	      ...
	      try { 
	        ...
	        while (reader.hasNext()) { 
	          ...
	          switch (code) { 
	            case START_ELEMENT: 
	              ...
	              break; 
	            case CHARACTERS: 
	            	System.out.println("currentElement.equalsIgnoreCase(name)"+currentElement.equalsIgnoreCase("name"));
	              
	            	
	            	
	            	if (currentElement.equalsIgnoreCase("IPAddress")) { 
	                propertyName += reader.getText(); 
	                System.out.println("propertyName=>"+propertyName);
	              } else if (currentElement.equalsIgnoreCase("IPAddress")) { 
	        ...
	        reader.close(); 
	        System.out.println(" propertyValue.trim()----->"+ propertyValue.trim());
