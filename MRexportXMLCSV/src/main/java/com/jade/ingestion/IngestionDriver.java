...
public class IngestionDriver extends Configured implements Tool {
...
public int run(String[] args) throws Exception {
	 Configuration conf= new Configuration();
	    ...
	    job.setJarByClass(IngestionDriver.class);
...
public static void main(String[] args) throws Exception  {
    int exitCode = ToolRunner.run(new IngestionDriver(), args);
